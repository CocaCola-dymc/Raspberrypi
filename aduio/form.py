...
class Ui_Sound_Detection(object):
    def setupUi(self, Sound_Detection):
        ...
        self.button1.setStyleSheet("QPushButton{border-radius: 10%;border: 1px solid black;background: url(/home/pi/aduio/images/filter_high.png) no-repeat cover center;}QPushButton:hover{border: 2px solid red;}")
        ...
        self.button2.setStyleSheet("QPushButton{border-radius: 10%;border: 1px solid black;background: url(/home/pi/aduio/images/filter_low.png) no-repeat cover center;}QPushButton:hover{border: 2px solid red;}")
        ...
        self.button3.setStyleSheet("QPushButton{border-radius: 10%;border: 1px solid black;background: url(/home/pi/aduio/images/brightness.png) no-repeat cover center;}QPushButton:hover{border: 2px solid red;}")
...
#        self.button5.setStyleSheet("QPushButton{border-radius: 10%;border: 1px solid black;background: url(/home/pi/aduio/images/brightness.png) no-repeat cover center;}QPushButton:hover{border: 2px solid red;}")
...
#        self.button4.setStyleSheet("QPushButton{border-radius: 10%;border: 1px solid black;background: url(/home/pi/aduio/images/battery_levels.png) no-repeat cover center;}QPushButton:hover{border: 2px solid red;}")
...
#        self.button4.setObjectName("button4")
        ...
        self.choose_value.setProperty("value", 10)
