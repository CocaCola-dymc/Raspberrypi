...
#        self.button5.setStyleSheet("QPushButton{border-radius: 10%;border: 1px solid black;background: url(/home/pi/aduio/images/com_probe.png) no-repeat cover center;}QPushButton:hover{border: 2px solid red;}")
...
#        self.button4.setObjectName("button4")
        ...
        self.battery_power.setGeometry(QtCore.QRect(910, 10, 118, 41))
        self.battery_power.setAutoFillBackground(False)
        self.battery_power.setStyleSheet("QProgressBar{text-align:center;border:2px solid gray;}QProgressBar::chunk{background-color:write;}")
        self.battery_power.setProperty("value", 0)
        self.battery_power.setTextVisible(False)
        self.battery_power.setObjectName("battery_power")
        self.label = QtWidgets.QLabel(self.widget)
        self.label.setGeometry(QtCore.QRect(870, 16, 32, 32))
        self.label.setStyleSheet("background-image: url(/home/pi/aduio/images/power_100.png);background-repeat: no-repeat;")
        self.label.setText("")
        self.label.setObjectName("label")
        self.choose_value = QtWidgets.QProgressBar(self.widget)
        self.choose_value.setGeometry(QtCore.QRect(1110, 80, 100, 481))
        self.choose_value.setLayoutDirection(QtCore.Qt.LeftToRight)
        ...
        self.choose_value.setMinimum(0)
    ...
    def retranslateUi(self, Sound_Detection):
        ...
        self.choose_value.setFormat(_translate("Sound_Detection", "%p"))
